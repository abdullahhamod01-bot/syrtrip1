...
export default function AddPlace() {
  ...
  const categories = [
    { value: "hotel", label: "Hotel", color: "#667eea" },
    { value: "restaurant", label: "Restaurant", color: "#f5576c" },
    { value: "attraction", label: "Attraction", color: "#4facfe" },
    { value: "transport", label: "Transport", color: "#fa709a" },
  ];
  ...
  const validate = () => {
    const newErrors = {};
    if (!form.id.trim()) newErrors.id = "Place ID is required";
    if (!form.name.trim()) newErrors.name = "Place name is required";
  ...
  const submit = async () => {
    ...
    try {
      ...
      setErrors({
        submit: err.response?.data?.message || "Failed to add place. Please try again.",
      });
    } finally {
      setLoading(false);
    }
    ...
    <div style={{ padding: "32px", maxWidth: 800, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: "#6b7280", fontSize: 15, margin: 0 }}>
          Add a new tourist place, attraction, or destination.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div style={{ gridColumn: "1 / -1" }}>
            ...
            >
              Place ID <span style={{ color: "#dc2626" }}>*</span>
            </label>
          ...
          <div style={{ gridColumn: "1 / -1" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <textarea
                name="description"
                placeholder="Describe the place, its features, and what visitors can expect..."
