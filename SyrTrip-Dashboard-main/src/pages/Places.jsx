    ...
    <div style={{ padding: "32px", maxWidth: 1400, margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          <p style={{ color: "#6b7280", fontSize: 15, margin: 0 }}>
            إدارة الأماكن والمعالم والوجهات السياحية
          </p>
        </div>
        {role === "admin" && (
          <Link
      ...
      >
        <div style={{ flex: 1, minWidth: 280, position: "relative" }}>
          ...
          <input
            type="text"
            placeholder="ابحث عن مكان بالاسم أو الموقع أو التصنيف..."
            value={searchQuery}
      ...
      >
        ...
        من أصل <strong style={{ color: "#111827" }}>{data.length}</strong> مكان
      </p>
      ...
      {loading ? (
        ...
        >
          ...
          <p style={{ color: "#9ca3af", fontSize: 14, margin: 0 }}>
            {searchQuery ? "حاول تعديل عبارة البحث" : "ابدأ بإضافة أول مكان"}
          </p>
        </div>
      ) : (
        <div
      ...
      {deleteConfirm && (
        ...
        >
          ...
          >
            ...
            >
              لا يمكن التراجع عن هذا الإجراء، وسيُحذف المكان نهائيًا.
            </p>
