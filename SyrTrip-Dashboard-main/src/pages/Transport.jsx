...
export default function Transport() {
  ...
  const load = async () => {
    ...
    try {
      ...
      const transportData = Array.isArray(res.data) ? res.data : [];
    ...
    <div style={{ padding: "32px", maxWidth: 1400, margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          <p style={{ color: "#6b7280", fontSize: 15, margin: 0 }}>
            إدارة خيارات وخدمات النقل
          </p>
        </div>
        {(role === "admin" || role === "car_owner") && (
          <Link
            to="/add-transport"
            style={{
              display: "flex",
      ...
      >
        <div style={{ flex: 1, minWidth: 280, position: "relative" }}>
          ...
          <input
            type="text"
            placeholder="ابحث عن وسيلة نقل بالاسم أو الموقع أو النوع..."
            value={searchQuery}
        ...
        >
          ...
          >
            ...
            <option value="fare">الترتيب حسب الأجرة</option>
          </select>
        </div>
      </div>
      ...
      >
        ...
        من أصل <strong style={{ color: "#111827" }}>{data.length}</strong>{" "}
        transport options
      </p>
      ...
      {loading ? (
        ...
        >
          ...
          >
            لم يتم العثور على خيارات نقل
          </h3>
          <p style={{ color: "#9ca3af", fontSize: 14, margin: 0 }}>
            {searchQuery
              ? "حاول تعديل عبارة البحث"
      ...
      {deleteConfirm && (
        ...
        >
          ...
          >
            ...
            >
              لا يمكن التراجع عن هذا الإجراء، وسيُحذف خيار النقل نهائيًا.
            </p>
