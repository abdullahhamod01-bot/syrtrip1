  ...
  if (role && role !== "admin") {
    return (
      <div style={{ padding: 40 }}>
        غير مصرح، يمكن للمديرين فقط إضافة الفعاليات.
      </div>
    );
  }
  ...
  const submit = async () => {
    ...
    try {
      ...
      setErrors({
        submit:
          err.response?.data?.message ||
          "فشل إضافة الفعالية. يرجى المحاولة مرة أخرى.",
      });
    } finally {
      setLoading(false);
    }
    ...
    <div style={{ padding: "32px", maxWidth: 900, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: "#6b7280", fontSize: 15, margin: 0 }}>
          أنشئ فعالية سياحية جديدة مع تفاصيل التاريخ والسعر والصور.
        </p>
      </div>
        ...
        >
          <div style={{ gridColumn: "1 / -1" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                name="name"
                placeholder="المعرض الدولي للذكاء الاصطناعي"
                value={form.name}
