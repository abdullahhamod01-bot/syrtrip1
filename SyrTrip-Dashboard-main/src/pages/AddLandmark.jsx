  ...
  if (role && role !== "admin") {
    return (
      <div style={{ padding: 40 }}>
        غير مصرح، يمكن للمديرين فقط إضافة المعالم.
      </div>
    );
  }
  ...
  const submit = async () => {
    ...
    try {
      ...
      setErrors({
        submit:
          err.response?.data?.message ||
          "فشل إضافة المعلم. يرجى المحاولة مرة أخرى.",
      });
    } finally {
      setLoading(false);
    }
    ...
    <div style={{ padding: "32px", maxWidth: 900, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: "#6b7280", fontSize: 15, margin: 0 }}>
          أضف موقعًا تاريخيًا أو معلمًا جديدًا.
        </p>
      </div>
